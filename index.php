      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="single-feature view">
            ...
            <p>Transaksi terjaga dan terjalin baik.</p>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="single-feature view">
            ...
            <p>Informasi merpati terupdate.</p>
          </div>
        </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>Merpati Terbaru</span></h2>
            <p>Kami meletakan stok merpati baru dibawah ini</p>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            ...
            <p>Produk Lainnya yang ada ditoko kami.</p>
          </div>
        </div>
      </div>
